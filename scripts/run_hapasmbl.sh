...
rm -rf ${hapasm_dir}/bam/${barcode_id}/${barcode_id}_filt.bam*
...
## hapasm_module3 used to this this
parallel '
...
if ! [[ $count -ge 2 ]]; then
    ...
    do
        ...
        flye --polish-target ${asm_dir}/${base_name}.con.fasta --nano-raw ${input_fq} --iterations 5 --out-dir ${asm_dir}/${hap_num}_flye_polish
